 ...
 */
public class ChannelUpdateArchivedEvent extends ChannelUpdateEvent<Boolean>
{
    ...
    public ChannelUpdateArchivedEvent(GenericChannelUpdateEvent<Boolean> jdaEvent) {
        super(jdaEvent);
    }
}
